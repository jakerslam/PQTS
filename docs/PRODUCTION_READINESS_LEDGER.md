...
| Point-in-time feature store | `PGQ-10` | Started | prediction-market microstructure feature builder | No durable feature registry/manifest yet. | Feature snapshots include lineage, schema, source, and quality flags. |
